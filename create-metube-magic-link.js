...
async function createMetubeMagicLink(userId) {
  try {
    console.log('\n🔗 Création du magic link pour Metube...');
    ...
    const testData = {
      token: token,
      user_id: userId,
      subscription_id: 'metube-sub-123',
      module_name: 'IAmetube', // Module Metube
...
// Script principal
(async () => {
  console.log('🚀 Création d\'un magic link pour Metube...\n');
  ...
  await createMetubeMagicLink(userIds[0]);
