...
MAGIC_LINK_SECRET=votre-secret-tres-securise-changez-cela-immediatement
...
STABLEDIFFUSION_URL=https://stablediffusion.iahome.fr
STABLEDIFFUSION_USERNAME=admin
STABLEDIFFUSION_PASSWORD=Rasulova75

# Configuration de l'application (Production NAS)
NEXT_PUBLIC_APP_URL=https://iahome.fr
NODE_ENV=production

# Configuration JWT
JWT_SECRET=votre-jwt-secret-tres-securise-changez-cela-immediatement
JWT_EXPIRES_IN=7d
