...
async function createGoogleMagicLink(userId) {
  try {
    console.log('\n🔗 Création du magic link pour Google...');
    ...
    const testData = {
      token: token,
      user_id: userId,
      subscription_id: 'google-sub-456',
      module_name: 'Google', // Module Google
...
// Script principal
(async () => {
  console.log('🚀 Création d\'un magic link pour Google...\n');
  ...
  await createGoogleMagicLink(userIds[0]);
